...
@patch("src.routers.dashboard.read_tool_result")
@patch("src.routers.dashboard.get_latest_process_history_entry")
@patch("src.routers.dashboard.read_agent_output")
@patch("src.routers.dashboard.read_watchlist")
def test_watchlist_dashboard_endpoint(mock_watchlist, mock_agent_output, mock_latest_history, mock_read_tool_result):
    ...
    mock_latest_history.return_value = {"timestamp": "2026-01-05T12:00:00+00:00"}
    ...
    assert row["last_updated"] == "2026-01-05T12:00:00+00:00"
...
@patch("src.routers.dashboard.read_agent_output")
@patch("src.routers.dashboard.read_watchlist")
def test_watchlist_dashboard_tolerates_an_uncached_quote(mock_watchlist, mock_agent_output, mock_latest_history, mock_read_tool_result):
    ...
    mock_latest_history.return_value = None
